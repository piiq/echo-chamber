"""FFT tools to analyze frequency content of audio segments.

This is not code for dealing with spectrogram images, but for analysis
of waveforms.
"""
import struct
import typing as T
...
def compute_fft(sound: pydub.AudioSegment) -> T.Tuple[np.ndarray, np.ndarray]:
    ...
    Parameters
    ----------
        sound: Audio segment to compute FFT of.
