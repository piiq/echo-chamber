...
def get_prompts_with_weights(
    ...
    """Tokenize a list of prompts and return its tokens with weights of each
    token.
...
def pad_tokens_and_weights(
    ...
    r"""Pad the tokens (with starting and ending tokens) and weights (with 1.0)
    to max_length."""
...
def get_unweighted_text_embeddings(
    ...
    """When the length of tokens is a multiple of the capacity of the text
    encoder, it should be split into chunks and sent to the text encoder
    individually."""
    ...
    if max_embeddings_multiples > 1:
        ...
        for i in range(max_embeddings_multiples):
            ...
            text_input_chunk = text_input[
                :,
                i * (chunk_length - 2) : (i + 1) * (chunk_length - 2) + 2,  # noqa: E203
            ].clone()
...
def get_weighted_text_embeddings(
    ...
    **kwargs,
    ...
    r"""Prompts can be assigned with local weights using brackets.
