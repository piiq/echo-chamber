...
class SpectrogramImageConverter:
    ...
    This is a wrapper around SpectrogramConverter that additionally
    converts from spectrograms to images and back. The real audio
    processing lives in SpectrogramConverter.
    """
    ...
    def __init__(self, params: SpectrogramParams, device: str = "cuda"):
        ...
        self.converter = SpectrogramConverter(params=params, device=self.device)
    ...
    def spectrogram_image_from_audio(
        ...
        """
        assert (  # nosec
            int(segment.frame_rate) == self.p.sample_rate
